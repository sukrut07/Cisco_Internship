...
VALID_TRANSITIONS: dict[str, list[str]] = {
    "CREATED": ["READY_FOR_DIAGNOSIS", "DIAGNOSING"],
    "READY_FOR_DIAGNOSIS": ["DIAGNOSING"],
    "DIAGNOSING": ["AWAITING_HUMAN_REVIEW"],
    "AWAITING_HUMAN_REVIEW": ["ACCEPTED", "EDITED", "REJECTED"],
    "ACCEPTED": ["FIX_RECORDED", "VERIFICATION_PENDING"],
    "EDITED": ["FIX_RECORDED", "VERIFICATION_PENDING"],
    "REJECTED": ["DIAGNOSING", "AWAITING_HUMAN_REVIEW"],
    "FIX_RECORDED": ["VERIFICATION_PENDING"],
    "VERIFICATION_PENDING": ["VERIFIED", "VERIFICATION_FAILED"],
    "VERIFIED": [],
    "VERIFICATION_FAILED": ["VERIFICATION_PENDING", "DIAGNOSING"],
}
